<template>
  <div class="dxHexiao">
  	<div class="header">
      <x-header :left-options="{showBack: true}">天翼积分商城</x-header>
    </div>
  ...
  <div style="margin-top: 30px;font-size: 14px;margin-left: 15px;">
  	<a href="http://jfdb.tyread.com:8080/cms/jfsc/index.jsp?enterpriseId=10003" style="text-decoration: underline;color: #f09a1a;">翼积分消费入口</a>
  </div>
  </div>
</template>
